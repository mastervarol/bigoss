    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td class="header-lg">
              Bukti Permohonan UNDAGI
            </td>
          </tr>
          <tr>
            <td class="free-text">
              Terima kasih telah menggunakan layanan permohonan online kami.
              <br>
              Konsultasikan desain arsitektur anda gratis.
            </td>
          </tr>
          <tr>
            <td class="mini-block-container">
                ...
                <tr>
                  <td class="mini-block">
                    <table cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <tr>
                        <td>
                          Alamat Rumah : <strong>{{$permohonan->alamat_rumah}}</strong><br>
                          Hp/Telp : <strong>{{$permohonan->telp}}</strong><br>
                          Lokasi Bangunan : <strong>{{$permohonan->lokasi_bangunan}}</strong><br>
                          No Akta/Sertifikat : <strong>{{$permohonan->no_ajb}}</strong><br>
                          Tgl Akta/Sertifikat : <strong>{{$permohonan->tgl_ajb}}</strong><br>
                          a/n (sesuai Akta/Sertifikat) : <strong>{{$permohonan->an_ajb}}</strong><br>
                          Terletak di (sesuai Akta/Sertifikat) : <strong>{{$permohonan->letak_ajb}}</strong><br>
                          Luas m<sup>2</sup> (sesuai Akta/Sertifikat) : <strong>{{$permohonan->luas_ajb}}</strong><br>
                        </td>
                      </tr>
                      <tr>
                        <td class="button">
        ...
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            <td style="padding: 25px 0 25px">
              <a href=""><img height="80" src="{{asset('assets/dist/img/logobadung.png')}}" alt="logo"></a><br>
              <strong>Dinas Penanaman Modal dan Pelayanan Terpadu Satu Pintu</strong><br />
              Pusat Pemerintahan Mangupraja Mandala, Jalan Raya Sempidi Mengwi (Kode Pos: 80351)<br />
              Telp : 0361-4715259, Fax : 0361- 4715258 <br /><br />
            </td>
          </tr>
        </table>
      </center>
