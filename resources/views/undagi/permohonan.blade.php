          ...
          <div class="box box-success">
            ...
            <div class="box-body">
              ...
              <div class="form-group {{ $errors->has('alamat_rumah') ? ' has-error' : '' }}">
                ...
                <input type="text" class="form-control" id="alamat_rumah" name="alamat_rumah" required="true" maxlength="100" value="{{old('alamat_rumah')}}">
              ...
              <div class="form-group {{ $errors->has('telp') ? ' has-error' : '' }}">
                ...
                <input type="tel" class="form-control" id="telp" name="telp" required="true" maxlength="100" value="{{old('telp')}}">
                @if ($errors->has('telp'))
                <span class="help-block">
              ...
              <div class="form-group {{ $errors->has('lokasi_bangunan') ? ' has-error' : '' }}">
                ...
                <input type="text" class="form-control" id="lokasi_bangunan" name="lokasi_bangunan" required="true" maxlength="100" value="{{old('lokasi_bangunan')}}">
              ...
              <div class="form-group {{ $errors->has('no_ajb') ? ' has-error' : '' }}">
                ...
                <input type="text" class="form-control" id="no_ajb" name="no_ajb" required="true" maxlength="100" value="{{old('no_ajb')}}">
              ...
              <div class="form-group {{ $errors->has('tgl_ajb') ? ' has-error' : '' }}">
                ...
                <input type="date" class="form-control" id="tgl_ajb" name="tgl_ajb" required="true" maxlength="100" value="{{old('tgl_ajb')}}">
              ...
              <div class="form-group {{ $errors->has('letak_ajb') ? ' has-error' : '' }}">
                ...
                <input type="text" class="form-control" id="letak_ajb" name="letak_ajb" required="true" maxlength="100" value="{{old('letak_ajb')}}">
              ...
              <div class="form-group {{ $errors->has('luas_ajb') ? ' has-error' : '' }}">
                ...
                <input type="text" class="form-control" id="luas_ajb" name="luas_ajb" required="true" maxlength="100" value="{{old('luas_ajb')}}">
              ...
              <div class="form-group {{ $errors->has('doc_kuasa') ? ' has-error' : '' }}">
                <label class="control-label" for="doc_kuasa">Upload Surat Kuasa</label>
