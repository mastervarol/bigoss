...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="{{url('admin/')}}" class="logo">
      ...
      <span class="logo-mini"><img src="{{asset('assets/dist/img/bigoss/antrianonline.png')}}" style="width: 50px; height: 50px;"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Antrian</b> Online</span>
    </a>
